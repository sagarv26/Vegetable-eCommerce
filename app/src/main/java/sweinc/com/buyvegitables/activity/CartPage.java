...
public class CartPage extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    private String ordered_list = "Caterers : Best In Market \n\nUser Ordered List\n\n";
        ...
        last_step.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!res.moveToNext()) {
                    ...
                    Toast.makeText(CartPage.this, "", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), CartBill.class);
...
//                    Log.e("Cart","Cost:"+cost+" Quantity:"+quantity);
                    ...
                    if (Long.valueOf(CartPage.this.bf_database.create(name, quantity, cost)).longValue() == -1) {
                        Toast.makeText(CartPage.this.getApplicationContext(), name + " : Not Added to cart", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(CartPage.this.getApplicationContext(), name + " : Added back to Cart", Toast.LENGTH_SHORT).show();
                    }
